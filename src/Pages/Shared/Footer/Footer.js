        ...
        <div>
            <div className='p-10 bg-white grid lg:grid-cols-[1fr_200px_200px_200px] md:grid-cols-[1fr_1fr] sm:grid-cols-[1fr] gap-4'>
                ...
                <div className='text-accent'>
                    ...
                    <li className='flex items-center'><FiArrowRight className='mr-1 right-array' /><a href="home">Home</a></li>
                    <li className='flex items-center'><FiArrowRight className='mr-1 right-array' /><a href="home">Our Factories</a></li>
                    <li className='flex items-center'><FiArrowRight className='mr-1 right-array' /><a href="home">About Us</a></li>
                    <li className='flex items-center'><FiArrowRight className='mr-1 right-array' /><a href="home">Products</a></li>
                </div>

                <div className='text-accent'>
                    <h3 className='text-accent font-bold text-2xl py-5'>Production</h3>
                    <li className='flex items-center'><FiArrowRight className='mr-1 right-array'></FiArrowRight><a href="home">Home</a></li>
                    <li className='flex items-center'><FiArrowRight className='mr-1 right-array' /><a href="home">Our Factories</a></li>
                    <li className='flex items-center'><FiArrowRight className='mr-1 right-array' /><a href="home">About Us</a></li>
                    <li className='flex items-center'><FiArrowRight className='mr-1 right-array' /><a href="home">Products</a></li>
                </div>
